sap.ui.define([
	...
	return BaseController.extend("purchaserequisitionapproval.controller.Master", {
 ...
 getRdaProperties: function(oEvent) {
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("PurchaseRequisition", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "purchaserequisitionapproval.view.ViewSettingsDialog",
					controller: this
