		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#PurchaseRequisitionApproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PurchaseRequisitionApproval-display": {
								"semanticObject": "PurchaseRequisitionApproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=purchaserequisitionapproval",
									"url": sap.ui.require.toUrl("purchaserequisitionapproval")
								}
							}
						}
					}
